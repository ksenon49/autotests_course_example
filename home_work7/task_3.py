...
class Buss(PublicTransport):
    def __init__(self, passengers, park, fare, brand, engine_power, year, color, max_speed):
...
class Tram(PublicTransport):
    def __init__(self, route, path, fare, brand, engine_power, year, color, max_speed):
        super().__init__(brand, engine_power, year, color, max_speed)
        self.__route = route
        self.path = path
        self._fare = fare
